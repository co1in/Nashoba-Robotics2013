...
public class RobotMap {
	...
	LiveWindow.addSensor("Track", "Quadrature Encoder 1", trackQuadratureEncoder1);
	...
	LiveWindow.addSensor("Track", "Analog Force 1", trackAnalogForce1);
        
        trackAnalogForce2 = new AnalogChannel(1, 4);
	LiveWindow.addSensor("Track", "Analog Force 2", trackAnalogForce2);
        
        trackBrakeSolenoid = new Solenoid(1, 1);
	LiveWindow.addActuator("Track", "Brake Solenoid", trackBrakeSolenoid);
        
        trackSpeedController1 = new Victor(1, 1);
	LiveWindow.addActuator("Track", "Speed Controller 1", (Victor) trackSpeedController1);
        
        trackSpeedController2 = new Victor(1, 2);
	LiveWindow.addActuator("Track", "Speed Controller 2", (Victor) trackSpeedController2);
        
        tippingSolenoid1 = new Solenoid(1, 2);
	LiveWindow.addActuator("Tipping", "Solenoid 1", tippingSolenoid1);
        
        pneumaticsCompressorDigitalInput1 = new DigitalInput(1, 3);
	LiveWindow.addSensor("Pneumatics Compressor", "Digital Input 1", pneumaticsCompressorDigitalInput1);
